...
public class JwtServiceImpl implements JwtService {
    ...
    private String generateToken(Map<String, Object> claims, UserDetails userDetails) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 60 * 80  ))//thoi gian het han
                .signWith(getKey(ACCESS_TOKEN), SignatureAlgorithm.HS256)// thuat toan
                .compact();
    ...
    private String generateRefreshToken(Map<String, Object> claims, UserDetails userDetails) {
        return Jwts.builder()
                ...
                .setSubject(userDetails.getUsername())
                .setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 60 * 24 * 12))//thoi gian het han
                .signWith(getKey(REFRESH_TOKEN), SignatureAlgorithm.HS256)// thuat toan
                .compact();
    }
    ...
    private String generateResetToken(Map<String, Object> claims, UserDetails userDetails) {
        return Jwts.builder()
                ...
                .setSubject(userDetails.getUsername())
                .setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 60 ))//thoi gian het han
                .signWith(getKey(RESET_TOKEN), SignatureAlgorithm.HS256)// thuat toan
                .compact();
    }
